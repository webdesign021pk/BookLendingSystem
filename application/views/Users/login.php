...
<div class="bg-dark text-light text-center align-center" style="height: 38px">
    <a class="navbar-brand"><i class="fas fa-book-open"></i> Library Management System</a>
</div>
<div class="container mt-5">
    <div class=" col-lg-6 align-center mx-auto">
        ...
        <div class="border rounded p-3 mt-3">
            <h5>Login Details</h5>
            <ul>
                <li><a href="#" id="superAdmin">Login as Super Admin</a></li>
                <li><a href="#" id="admin">Login as Admin</a></li>
                <li><a href="#" id="librarian">Login as Librarian</a></li>
            </ul>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $('#librarian').click(function(){
        $('#userName').val('Librarian');
        $('#password').val('librarian');
    });
</script>