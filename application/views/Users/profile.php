...
<!-- Body Content Start -->
    ...
    <div class="row">
        <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <form class="mt-3" action="<?= base_url('Library/Settings/profile/'.$user->userIdPK)?>" method="POST">
            ...
            <form class="mt-1 border-top" action="<?= base_url('Library/Settings/profile/'.$user->userIdPK)?>" method="POST">
                <div class="row mt-2">
                    <div class="col-lg-6 col-md-6">
        ...
        <div class="col-lg-3 col-md-12 col-sm-12">
            <form class="mt-3 modifyInstitute border-left" action="<?= base_url('Library/Settings/modifyPass')?>" method="POST">
                <div class="row ml-3">
